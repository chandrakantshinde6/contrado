...
namespace Contrado.Controllers
{
    ...
    {
        //ParameterList ListOfConsignment = new ParameterList();
        ...
        //[Route("api/[controller]/Validate_Consignment")]
        //[HttpPatch]
        //public ActionResult Validate_Consignment()
        //{
        //    ValidateParameterResponse response = new ValidateParameterResponse();
        //    response.validate();
        //    return Ok(ParameterList.Consignment_details);
        //}
